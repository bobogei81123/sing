...
let questions = [{
    question: '{誰:後藤新平}的叔公為{何人:高野長英}，幕末曾著{何著作:戊戌夢物語}批判幕府\
不分青紅皂白砲擊外國船隻的失策。',
    level: 3
}, {
...
推行穩健的文化政治，最後卒於{何事件:二二六事件}。',
    ...
    question: '和{誰:坂上田村麻呂}並稱平安時代雙璧的{誰:菅原道真}，提倡{何思想:和魂漢才}，\
...
內閣執意干涉{何事件:俄國革命}出兵{何處:西伯利亞}。其內閣垮臺後由{誰:原敬}組閣。',
    ...
    question: '關東大地震後，{哪三人:吉野作造、尾佐竹猛、宮武外骨}成立了{何機構:明治文化研究會}\
。該會後編纂了{何著作:明治文化全集}。',
    level: 3
}, {
...
後來又完成了烏山頭水庫和嘉南大圳的設計，並獲得{誰:田健治郎}總督的支持。',
    ...
    question: '第 7 任臺灣總督為{誰:明石元二郎}，當時的總務長官為{誰:下村宏}。',
    level: 3
}, {
...
而蓬萊米由第 10 任臺灣總督{誰:伊澤多喜男}命名。',
    ...
    question: '戊辰戰爭最激烈的{何戰爭:北越戰爭}中，{誰:河井繼之助}一度奪回被新政府軍攻占的長岡城，\
...
疾如風、徐如林、侵略如火、不動如山}四句話。',
    ...
    question: '為了防止各地的大名造反，在{何處:箱根關所}會特別檢查兩項，{哪兩項:出女和入鐵砲}。',
    level: 3
}, {
...
{何機構:帝都防衛司令}的要求，亦在戰後堅拒 GHQ 將東大做為{何機構:盟軍總部}的要求。',
    ...
    question: '真田家族三代分別是{誰:真田幸隆}、{誰:真田昌幸}、{誰:真田信繁}，其中最後一位曾死守{何處:上田}。',
    level: 3
}, {
    question: '板本龍馬在{何事件:寺田屋事件}險遭殺害，但在{何事件:近江屋事件}被暗殺。',
    level: 3
}];
